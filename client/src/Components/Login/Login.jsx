        ...
        <div>
            <div className="form-signin Login-form-hepler-block">
                <div className="Login-div-helper-block">
                    ...
                    <input value={AuthState.loginEmail} type="email" className={AuthState.loginERROR ? "form-control is-invalid" : "form-control"} placeholder="Email address" required="" autofocus="" onChange={event => AuthState.changeLoginEmail(event.target.value)}/>
